...
```{r, solution_01a}
### r = language to use, solution_01 means the name for the chunk
## your code here
library(ggplot2)
ggplot(data = iris) +
  geom_histogram(aes(x = Sepal.Length, binwidth = 6))
```
...
library(ggplot2)
ggplot(data = iris) +
  geom_histogram(aes(x = Sepal.Length, color = "black"))
```
...
library(ggplot2)
ggplot(data = iris) +
  geom_histogram(aes(x = Sepal.Length, color = "navyblue", fill = "gold"))
```
...
library(ggplot2)
ggplot(data = iris) +
  geom_histogram(aes(x = Sepal.Length, color = "navyblue", fill = "gold", size = 1.55))
```
...
library(ggplot2)
ggplot(data = iris) +
  geom_histogram(aes(x = Sepal.Length, color = "navyblue", fill = "gold", size = 1.55, alpha = 0.5))
```
...
### your code here
ggplot(data = diamonds) +
  geom_boxplot(aes(x=color, y=price, fill='carat > median(carat)')) +
  facet_grid(clarity~cut) +
...
diamonds %>% 
  ...
  ggplot(diamonds, mapping = aes(x = color, y = price))  + geom_boxplot(aes( x = color, y = price, fill = 'carat > median(diamonds$carat)')) +
  facet_grid(clarity~cut) +
  theme(legend.position = 'top')
```
...
### your code here
library(ggplot2)
ggplot(mpg, aes(x = displ, y = hwy)) + geom_point() + geom_smooth(method = lm, formula = y ~ x )
```
...
```{r, solution_03e}
### your code here
###aesthetic all edit in()
library(ggplot2)
ggplot(data = mpg,aes(x = displ, y = hwy)) + geom_point() +
  geom_smooth(mapping = aes(x = displ, y = hwy, colour = drv), formula = y~x, method = lm)
```
...
library(ggplot2)
ggplot(data = mpg,aes(x = displ, y = hwy)) + geom_point() +
  geom_smooth(mapping = aes(x = displ, y = hwy, group = drv), formula = y ~ x, method = lm)
###what is don't map any variable to the color aesthetic?
```
...
### your code here
mod1 <- lm(hwy ~ displ, mpg)
summary(mpg) ###inspect information of dataset
